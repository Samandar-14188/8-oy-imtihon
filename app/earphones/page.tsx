...
export default function Page() {
  ...
  const id = data?.id || '1';
  const description = data?.description ?? 'Tailor your listening experience with bespoke dynamic drivers from the new YX1 Wireless Earphones. Enjoy incredible high-fidelity sound even in noisy environments with its active noise cancellation feature.';
  ...
  return (
    <div>
      ...
      <div className="earphones-container">
        ...
        <InformationCard title={name} paragraf={description} text="NEW PRODUCT" id={id} />
      </div>
      <LinkHome />
      <HomeInformation />
      <Footer />
